...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    setMessage(true);
    emailjs.sendForm("service_k2qawqh", "template_c6rkpn6", formRef.current, "X7K7ebhIeOy3YwHki").then(
      (result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            <h5>wasimakram97091@gmail.com</h5>
            <a href="mailto:wasimakram97091@gmail.com">Send a message</a>
          </article>
        </div>
